...
import static com.badlogic.gdx.graphics.text.harfbuzz.HarfBuzzUtil.Buffer;
import static com.badlogic.gdx.graphics.text.harfbuzz.HarfBuzzUtil.Face;
import static com.badlogic.gdx.graphics.text.harfbuzz.HarfBuzzUtil.Font;
import static com.badlogic.gdx.graphics.text.harfbuzz.HarfBuzzUtil.Font.hb_shape_list_shapers_strings;
import static com.badlogic.gdx.graphics.text.harfbuzz.HarfBuzzUtil.hb_tag_to_string;
...
public class HarfBuzzTest {
        ...
        new Lwjgl3Application(new ApplicationAdapter(){
            ...
            public void render() {
                ...
                if (Gdx.input.isKeyPressed(Input.Keys.F6)) {
                    ...
                    //Caret
                    if (Gdx.input.isButtonPressed(Input.Buttons.LEFT)) {
                        caretIndex = Math.max(0, layout.getIndexAt(mouse.x - textX, mouse.y  - textY, true));
                    }
                    final Rectangle caretRect = layout.getCaretPosition(caretIndex);
                    if (caretRect != null) {
                        caretRect.width = 1f;
    ...
    public static void main(String[] args) {
        Configuration.HARFBUZZ_LIBRARY_NAME.set(org.lwjgl.util.freetype.FreeType.getLibrary());
